import * as KcApiRequest from '../api/user/model/dto/users';
...
export class HttpService {
    ...
    private async post<T>(
        ...
        if (response.problem) {
            ...
            return errorResponse(400, data.errorMessage || data.error ? data.errorMessage || data.error : response.problem as string)
        }
    }
