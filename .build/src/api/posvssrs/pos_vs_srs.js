...
exports.posVsSrsHandler = void 0;
const jwks_1 = require("../../auth/jwks");
const response_1 = require("../../utility/response");
const core_1 = __importDefault(require("@middy/core"));
const http_json_body_parser_1 = __importDefault(require("@middy/http-json-body-parser"));
const tag = 'posVssrs-handler';
exports.posVsSrsHandler = (0, core_1.default)((event) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
//# sourceMappingURL=pos_vs_srs.js.map